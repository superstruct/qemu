...
// Begin JS library code
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(4, 0, 1, path);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(5, 0, 1, path, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(7, 0, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(8, 0, 1, fd, newfd, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(9, 0, 1, dirfd, path, amode, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(10, 0, 1, fd, mode);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(11, 0, 1, dirfd, path, mode, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(12, 0, 1, fd, owner, group);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(13, 0, 1, dirfd, path, owner, group, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(14, 0, 1, fd, cmd, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(15, 0, 1, fd, buf);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(16, 0, 1, fd, length);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(17, 0, 1, buf, size);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(18, 0, 1, fd, dirp, count);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(20, 0, 1, fd, addr, addrlen, d1, d2, d3);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(21, 0, 1, fd, level, optname, optval, optlen, d1);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(22, 0, 1, fd, op, varargs);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(41, 0, 1, dirfd, path, times, flags);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(42, 0, 1, len, prot, flags, fd, offset, allocated, addr);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(49, 0, 1, fd, offset, whence, newOffset);
  ...
  function(fd) {
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(50, 0, 1, fd);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(51, 0, 1, fd, iov, iovcnt, pnum);
  ...
  if (ENVIRONMENT_IS_PTHREAD)
    return proxyToMainThread(52, 0, 1, node, service, hint, out);
...
function assignWasmExports(wasmExports) {
  ...
  dynCalls['viijji'] = dynCall_viijji = createExportWrapper('dynCall_viijji', 6);
  ...
  dynCalls['vijjji'] = dynCall_vijjji = createExportWrapper('dynCall_vijjji', 6);
  dynCalls['iijii'] = dynCall_iijii = createExportWrapper('dynCall_iijii', 5);
  dynCalls['iijiii'] = dynCall_iijiii = createExportWrapper('dynCall_iijiii', 6);
  ...
  dynCalls['iiijii'] = dynCall_iiijii = createExportWrapper('dynCall_iiijii', 6);
  dynCalls['iiiiijii'] = dynCall_iiiiijii = createExportWrapper('dynCall_iiiiijii', 8);
  dynCalls['viiiiiiiiiiiii'] = dynCall_viiiiiiiiiiiii = createExportWrapper('dynCall_viiiiiiiiiiiii', 14);
